...
A *body* element contains the rendered portion of a page. Not all visible elements may be placed directly inside, but none can go outside it.
...
After that, you should be thinking about Web pages as heirarchies, or trees. [The next lesson](03.md) focuses on what Visual Studio offers to help you author them.
